...
sys.path.insert(0, os.path.abspath("../disco"))
...
#
html_theme_options = {
    "description": "Magnetospheric Particle Trajectory Modeling on the GPU.",
    "show_related": True,
    "github_banner": False,
    "github_button": False,
...
latex_documents = [
    (master_doc, "disco.tex", "DISCO Documentation", "Author", "manual"),
]
...
man_pages = [(master_doc, "disco", "disco Documentation", [author], 1)]
